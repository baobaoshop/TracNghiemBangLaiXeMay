 ...
 * Use the {@link FragmentThucHanh#newInstance} factory method to
...
public class FragmentThucHanh extends Fragment {
     ...
     * @return A new instance of fragment FragmentThucHanh.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentThucHanh newInstance(String param1, String param2) {
        FragmentThucHanh fragment = new FragmentThucHanh();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("BangLaiXe").child("MeoThi").child("meothithuchanh");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycleViewThucHanh);
