...
public class AdapterCustomerLoaiBienBao extends ArrayAdapter {
    Context context;
    int layout;
    ArrayList<LoaiBienBao> list = new ArrayList<>();
    public AdapterCustomerLoaiBienBao(@NonNull Context context, int resource, @NonNull ArrayList<LoaiBienBao> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        LoaiBienBao student = list.get(position);
        if(convertView==null){
